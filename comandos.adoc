...
Para resolver esse dilema, neste caso, use o comando `xref` no lugar de `link`.
...
Mas para isso funcionar, é preciso incluir o comando `if` abaixo no topo de cada documento:
